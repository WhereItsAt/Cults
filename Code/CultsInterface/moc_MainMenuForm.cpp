...
const QMetaObjectExtraData MainMenuForm::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MainMenuForm::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MainMenuForm,
      qt_meta_data_MainMenuForm, &staticMetaObjectExtraData }
};
