...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sun Jun 4 00:06:33 2017
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux/CultsInterface1.0.0/ && $(COPY_FILE) --parents Assett.h Buisness.h Bureaucrat.h CEO.h CImg.h Commander.h Cult.h Evangelist.h FederalGovernment.h FederalLeader.h FollowerManager.h GoverningBody.h Government.h GovernmentLeader.h Individual.h Leader.h LocalGovernment.h LocalLeader.h MainMenuForm.h Manager.h Policy.h PoliticalParty.h Politician.h Priest.h Religion.h ResourceManager.h Specialist.h Spy.h StatusManager.h UniqueFollower.h Zone.h ZoneManager.h build/Debug/GNU-Linux/CultsInterface1.0.0/ && $(COPY_FILE) --parents Assett.cpp Buisness.cpp Bureaucrat.cpp CEO.cpp Commander.cpp Cult.cpp Evangelist.cpp FederalGovernment.cpp FederalLeader.cpp FollowerManager.cpp GoverningBody.cpp Government.cpp GovernmentLeader.cpp Individual.cpp Leader.cpp LocalGovernment.cpp LocalLeader.cpp MainMenuForm.cpp.cc Manager.cpp Policy.cpp PoliticalParty.cpp Politician.cpp Priest.cpp Religion.cpp ResourceManager.cpp Specialist.cpp Spy.cpp StatusManager.cpp UniqueFollower.cpp Zone.cpp ZoneManager.cpp main.cpp build/Debug/GNU-Linux/CultsInterface1.0.0/ && $(COPY_FILE) --parents MainMenuForm.ui build/Debug/GNU-Linux/CultsInterface1.0.0/ && (cd `dirname build/Debug/GNU-Linux/CultsInterface1.0.0` && $(TAR) CultsInterface1.0.0.tar CultsInterface1.0.0 && $(COMPRESS) CultsInterface1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux/CultsInterface1.0.0`/CultsInterface1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux/CultsInterface1.0.0
