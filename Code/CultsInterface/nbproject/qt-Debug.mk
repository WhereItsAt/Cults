...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sun Jun 18 01:03:59 2017
...
SOURCES       = Assett.cpp \
		...
		ZoneManager.cpp \
		main.cpp \
		myCity.cpp moc_MainMenuForm.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux/CultsInterface1.0.0/ && $(COPY_FILE) --parents Assett.h Base.h Building.h Buisness.h Bureaucrat.h CEO.h CImg.h CommandCenter.h Commander.h Country.h Cult.h Empire.h Evangelist.h FederalGovernment.h FederalLeader.h FollowerManager.h GoverningBody.h Government.h GovernmentLeader.h HeadQuarters.h Improvement.h Individual.h Leader.h LocalGovernment.h LocalLeader.h MainMenuForm.h Manager.h Policy.h PoliticalParty.h Politician.h Priest.h RegionalZone.h Religion.h ResourceManager.h SafeHouse.h Specialist.h Spy.h StatusManager.h StoryEvent.h Suburb.h UniqueFollower.h Zone.h ZoneManager.h myCity.h build/Debug/GNU-Linux/CultsInterface1.0.0/ && $(COPY_FILE) --parents Assett.cpp Base.cpp Building.cpp Buisness.cpp Bureaucrat.cpp CEO.cpp CommandCenter.cpp Commander.cpp Country.cpp Cult.cpp Empire.cpp Evangelist.cpp FederalGovernment.cpp FederalLeader.cpp FollowerManager.cpp GoverningBody.cpp Government.cpp GovernmentLeader.cpp HeadQuarters.cpp Improvement.cpp Individual.cpp Leader.cpp LocalGovernment.cpp LocalLeader.cpp MainMenuForm.cpp.cc Manager.cpp Policy.cpp PoliticalParty.cpp Politician.cpp Priest.cpp RegionalZone.cpp Religion.cpp ResourceManager.cpp SafeHouse.cpp Specialist.cpp Spy.cpp StatusManager.cpp StoryEvent.cpp Suburb.cpp UniqueFollower.cpp Zone.cpp ZoneManager.cpp main.cpp myCity.cpp build/Debug/GNU-Linux/CultsInterface1.0.0/ && $(COPY_FILE) --parents MainMenuForm.ui build/Debug/GNU-Linux/CultsInterface1.0.0/ && (cd `dirname build/Debug/GNU-Linux/CultsInterface1.0.0` && $(TAR) CultsInterface1.0.0.tar CultsInterface1.0.0 && $(COMPRESS) CultsInterface1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux/CultsInterface1.0.0`/CultsInterface1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux/CultsInterface1.0.0
