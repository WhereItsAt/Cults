...
""));
    ...
    {
        MainMenuForm->setWindowTitle(QApplication::translate("MainMenuForm", "MainMenuForm", 0, 0));
        TitleLabel->setText(QApplication::translate("MainMenuForm", "Cults", 0, 0));
        BackgroundImage->setText(QString());
        NewButton->setText(QApplication::translate("MainMenuForm", "New Game", 0, 0));
        LoadButton->setText(QApplication::translate("MainMenuForm", "Load Game", 0, 0));
        OptionsButton->setText(QApplication::translate("MainMenuForm", "Options", 0, 0));
        ExitButton->setText(QApplication::translate("MainMenuForm", "Exit", 0, 0));
    } // retranslateUi
