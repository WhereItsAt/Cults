...
""));
    ...
    {
        OptionsForm->setWindowTitle(QApplication::translate("OptionsForm", "OptionsForm", 0, 0));
        TitleLabel->setText(QApplication::translate("OptionsForm", "Options", 0, 0));
        Picture->setText(QString());
        mainMenuButton->setText(QApplication::translate("OptionsForm", "Back to Main Menu", 0, 0));
        DisplayButton->setText(QApplication::translate("OptionsForm", "Display", 0, 0));
        soundButton->setText(QApplication::translate("OptionsForm", "Sound", 0, 0));
        gameplayButton->setText(QApplication::translate("OptionsForm", "Gameplay", 0, 0));
        GraphicsButton->setText(QApplication::translate("OptionsForm", "Graphics", 0, 0));
    } // retranslateUi
